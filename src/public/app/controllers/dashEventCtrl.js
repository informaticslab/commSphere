...
$scope.saveColName = function(col,e) {
    ...
    col.editing = false;
    e.preventDefault();
    if (col.displayName !== col.newColName && col.newColName !== '') {
